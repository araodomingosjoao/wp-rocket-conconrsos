...
?>
	...
	<div class="question-create-page">
		<div>
			...
			<button style="display: none;" class="save-page-button button button-primary"><?php esc_html_e('Save Questions and Pages', 'quiz-master-next'); ?></button>
							...
							<div id="postbox-container-1" class="postbox-container">
								<div id="side-sortables" class="meta-box-sortables ui-sortable" style="">
									...
									<div id="featureImagediv" class="postbox">
										<h2 class="hndle ui-sortable-handle">
											<span><?php esc_html_e('Selecione as categorias', 'quiz-master-next'); ?></span>
										</h2>
										<div class="inside">
											<?php
												echo '<a href="javascript:void(0)" class="add-category" title="Add Category"><span class="dashicons dashicons-admin-generic"></span></a>';
											?>
										</div>
									</div>
									<div id="featureImagediv" class="postbox">
	...
	<div class="qsm-popup qsm-popup-slide qsm-standard-popup" id="modal-page-1" aria-hidden="true">
		<div class="qsm-popup__overlay" tabindex="-1" data-micromodal-close>
			<div class="qsm-popup__container" role="dialog" aria-modal="true" aria-labelledby="modal-1-title">
				<header class="qsm-popup__header">
					<h2 class="qsm-popup__title" id="modal-1-title"><?php esc_html_e('Edit Page', 'quiz-master-next'); ?> <span style="display: none;">[ ID: <span id="edit-page-id"></span> ]</span></h2>
					<a class="qsm-popup__close" aria-label="Close modal" data-micromodal-close></a>
				</header>
	...
	<div class="qsm-popup qsm-popup-slide qsm-standard-popup" id="modal-page-category" aria-hidden="true">
		<div class="qsm-popup__overlay" tabindex="-1" data-micromodal-close>
			<div class="qsm-popup__container" role="dialog" aria-modal="true" aria-labelledby="modal-1-title">
				<header class="qsm-popup__header">
					<h2 class="qsm-popup__title" id="modal-1-title"><?php esc_html_e('Selecione as categorias', 'quiz-master-next'); ?> <span style="display: none;">[ ID: <span id="edit-page-id"></span> ]</span></h2>
					<a class="qsm-popup__close" aria-label="Close modal" data-micromodal-close></a>
				</header>
				<main class="qsm-popup__content" id="modal-page-category-content">
					<form action="" method="post" id="form_category_question">
						<?php
						global $wpdb;
						...
						foreach ($array as $category => $terms) { ?>
							<div id="categorydiv" class="postbox">
								...
								<div class="inside">
									<div id="multi_category_area" class="qsm-row multi_category_area ">
	...
	<div class="qsm-popup qsm-popup-slide" id="modal-8" aria-hidden="false">
		<div class="qsm-popup__overlay" tabindex="-1" data-micromodal-close="">
			<div class="qsm-popup__container" role="dialog" aria-modal="true" aria-labelledby="modal-8-title">
				...
				<hr />
				<footer class="qsm-popup__footer">
					<button id="cancel-button" class="qsm-popup__btn" data-micromodal-close="" aria-label="Close this dialog window"><?php esc_html_e('Cancel', 'quiz-master-next'); ?></button>
				</footer>
			</div>
		</div>
	</div>
...
function qsm_ajax_save_category()
{
	global $wpdb;

	if (isset($_POST['question_id']) && isset($_POST['terms'])) {
		...
		foreach ($terms as $term) {
			$wpdb->insert(
				$wpdb->prefix . 'mlw_questions_terms',
				array(
